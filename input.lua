...
-- RetroPad → IDs
local JOY = {
	B = 1, Y = 2, SELECT = 3, START = 4,
	UP = 5, DOWN = 6, LEFT = 7, RIGHT = 8,
	A = 9, X = 10, L = 11, R = 12,
	L2 = 13, R2 = 14, L3 = 15, R3 = 16
}

-- RetroPad ID → Gamepad name
local GAMEPAD_MAP = {
	[JOY.B] = "b", [JOY.Y] = "y", [JOY.SELECT] = "back", [JOY.START] = "start",
	[JOY.UP] = "dpup", [JOY.DOWN] = "dpdown", [JOY.LEFT] = "dpleft", [JOY.RIGHT] = "dpright",
	[JOY.A] = "a", [JOY.X] = "x", [JOY.L] = "leftshoulder", [JOY.R] = "rightshoulder",
	[JOY.L2] = "lefttrigger", [JOY.R2] = "righttrigger", [JOY.L3] = "leftstick", [JOY.R3] = "rightstick"
}
